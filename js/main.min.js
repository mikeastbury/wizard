...
function init() {
    drawTitle();
    attachEventHandlers();
    STATE.playerDetails.forEach(function (player) {
        drawPlayer(player);
    });
}
...
function attachEventHandlers() {
    ...
    $('.testButton').click(function () {
        var enteredName = $('.nameField').val();
        var userName = { name: enteredName };
...
function addPlayer() {
    var numberOfPlayers = STATE.playerDetails.length + 1;
    var newPlayer = { name: 'Player ' + numberOfPlayers };
...
function drawTitle() {
    $('h2.title').append('How many players?');
}
